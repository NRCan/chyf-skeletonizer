 ...
 * @author bowens
 *
 * An extension of com.vividsolutions.jts.geom.Point that 
 * contains extra metadata used for segment removal.
 */
final public class SkelPoint extends Point 
{

	public int segNumber;		// meta information
	 ...
	 * @param pm
	 * @param i	SRID
	 * @param seg	meta information for segNumber
	 */
