...
public class SkeletonizerExtension extends Extension {

	public void configure(PlugInContext context) throws Exception {
		context.getFeatureInstaller().addMainMenuItem(
	    new SkeletonizeDatasetPlugin(), new String[] {"Skeletonize"},
			 "Skeletonize Wizard...", false, null, new MultiEnableCheck() 
	  );
	}
