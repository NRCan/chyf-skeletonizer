...
public class InputVoronoiCoordinate extends Coordinate
{
	public int riverPoint = 0; // 0= no, #=id
    
	public InputVoronoiCoordinate(Coordinate c,int riverPointID) 
	{
			super(c);
			riverPoint = riverPointID;
	}
	
	   public InputVoronoiCoordinate(double x,double y,int riverPointID) 
		{
				super(x,y);
				riverPoint = riverPointID;
		}
